...
#### 6. Если материал относится к конкретной модели (не общего пользования), добавляйте к имени материала имя модели в `camel_case`
...
#### 3. Другие ассеты должны быть помещены в корень директории компонента или дальше разделены в "AssetType-based" структуру дирикторий если их слишком много
